...
type Props = {
  open: boolean;
  onClose: () => void;
  /** Callback após alterações (ex.: para refrescar a lista pública). */
  onChanged?: () => void;
};

export function RecommendedServicesAdminModal({ open, onClose, onChanged }: Props) {
  ...
  const innerOpen = addModalOpen || Boolean(editId);
    ...
    <>
      <ModalPortal>
        <div
          ...
          role="presentation"
          onClick={(e) => {
            if (e.target === e.currentTarget && !innerOpen) onClose();
          }}
        >
          <div
            role="dialog"
            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-zinc-600">
                  ...
                  . Cada item abre <code className="text-xs">/link?t=…</code> e
