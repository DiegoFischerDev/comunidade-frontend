/** Alinhado ao seed do backend — usado se a API não estiver disponível. */
export const YOUTUBE_HIGHLIGHT_FALLBACKS: Array<{
  id: string;
  title: string;
  thumb: string;
  href: string;
}> = [
  {
    ...
    thumb: "https://img.youtube.com/vi/nSuXTX0z9Vk/hqdefault.jpg",
  ...
  },
  {
    ...
    thumb: "https://img.youtube.com/vi/v04RVqeT9aQ/hqdefault.jpg",
    href: "https://www.youtube.com/watch?v=v04RVqeT9aQ&list=PLE6qyBhvOLI0C0Ardu5fY3z8JK3kv-OKI&index=12",
  },
  {
    id: "yt-3",
    title: "🏡 Ep 6 | Primeiros dias na nossa casa na aldeia em Portugal 🇵🇹",
    thumb: "https://img.youtube.com/vi/Z4Dv3M2ZLOQ/hqdefault.jpg",
